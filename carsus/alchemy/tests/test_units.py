import pytest
from carsus.alchemy import UnitDB, PhysicalType
...
#def test_add_physical_type_before_flush(memory_session):
#    u_m = UnitDB(unit=u.m)
#    memory_session.add(u_m)
#    memory_session.flush()
#    assert u_m.physical_type.type == 'length'


#def test_add_physical_type_before_flush_as_unique(memory_session):
#    u_m = UnitDB.as_unique(memory_session, unit=u.m)
#    memory_session.flush()
#    assert u_m.physical_type.type == 'length'
